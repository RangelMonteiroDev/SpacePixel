...
switch (sprite_name) {
	...
	script_hits_in_npc(obj_bala_laiser, obj_bala_npc_child_04, 7);	
	break
	...
	script_hits_in_npc(obj_bala_laiser, obj_bala_npc_child_04, 20);	
	break
	...
	script_hits_in_npc(obj_bala_laiser, obj_bala_npc_child_01, 30);	
	break
