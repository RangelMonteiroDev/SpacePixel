...
switch (sprite_name) {
	...
	script_hits_in_npc(obj_bala_laiser, obj_bala_npc_child_02, 7);	
	break
	...
	script_hits_in_npc(obj_bala_laiser, obj_bala_npc_child_02, 20);	
	break
	...
	script_hits_in_npc(obj_bala_laiser, obj_bala_npc_child_02, 30);	
	break
